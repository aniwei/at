...
export class TapGestureRecognizer extends PrimaryPointerGestureRecognizer {
  static create (gesture: Gesture): TapGestureRecognizer {
    return new TapGestureRecognizer(gesture) 
  }
  ...
  constructor (gesture: Gesture) {
    super(gesture, Gesture.env<number>('ATKIT_GESTURE_PRESS_TIMEOUT', 100))
  }
