...
export class Flex extends Box {
  ...
  public get overflowed () {
    return this.overflow > Engine.env<number>('PRECISION_ERROR_TOLERANCE', 1e-10)
  }
  ...
  computeSizes (
    ...
    while (child !== null) {
      ...
      child = this.nextSibling as Flexible ?? null
    }
